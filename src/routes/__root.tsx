  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Institutional positioning terminal. CFTC Commitments of Traders, read the White Oak way — commercial accumulation, retail divergence, and extreme readings.",
      },
